...
#[RequiresPermission(CustomAttributePermissions::CREATE)]
final readonly class CreateDefinitionCommand implements CommandInterface, AuthorizedMessageInterface
{
    /**
