...
use GardenManager\CustomAttribute\Application\Command\SetAttributeValuesCommandHandler;
...
#[Group('unit')]
final class SetAttributeValuesCommandHandlerTest extends TestCase
{
    #[Test]
    public function createsNewValues(): void
    {
        ...
        $handler = new SetAttributeValuesCommandHandler($defRepo, $valueRepo);
