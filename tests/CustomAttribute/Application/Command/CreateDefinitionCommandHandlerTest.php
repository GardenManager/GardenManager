...
use GardenManager\CustomAttribute\Application\Command\CreateDefinitionCommandHandler;
...
#[Group('unit')]
final class CreateDefinitionCommandHandlerTest extends TestCase
{
    #[Test]
    public function createsDefinition(): void
    {
        ...
        $handler = new CreateDefinitionCommandHandler($repo);
