...
use GardenManager\CustomAttribute\Application\Command\DeleteDefinitionCommandHandler;
...
#[Group('unit')]
final class DeleteDefinitionCommandHandlerTest extends TestCase
{
    #[Test]
    public function deletesDefinition(): void
    {
        ...
        $handler = new DeleteDefinitionCommandHandler($repo, new TenantAccessChecker());
