...
use GardenManager\CustomAttribute\Application\Command\UpdateDefinitionCommandHandler;
...
#[Group('unit')]
final class UpdateDefinitionCommandHandlerTest extends TestCase
{
    #[Test]
    public function updatesDefinition(): void
    {
        ...
        $handler = new UpdateDefinitionCommandHandler($repo, new TenantAccessChecker());
