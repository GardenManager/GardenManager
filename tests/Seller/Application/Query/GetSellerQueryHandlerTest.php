...
use GardenManager\Seller\Application\Query\GetSellerQueryHandler;
...
#[Group('unit')]
final class GetSellerQueryHandlerTest extends TestCase
{
    #[Test]
    public function returnsSellerDetailView(): void
    {
        ...
        $handler = new GetSellerQueryHandler($repo, new TenantAccessChecker());
