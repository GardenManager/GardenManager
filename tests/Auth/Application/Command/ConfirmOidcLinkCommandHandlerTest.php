...
use GardenManager\Auth\Application\Command\ConfirmOidcLinkCommandHandler;
...
#[Group('unit')]
final class ConfirmOidcLinkCommandHandlerTest extends TestCase
{
    #[Test]
    public function createsLinkWhenPasswordIsValid(): void
    {
        ...
        $handler = new ConfirmOidcLinkCommandHandler($userRepo, $oidcRepo, $hasher);
